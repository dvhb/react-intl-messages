...
@dvhb/react-intl-messages/0.0.1 darwin-x64 node-v10.15.3
...
_See code: [src/commands/clean.ts](https://github.com/dvhb/react-intl-messages/blob/v0.0.1/src/commands/clean.ts)_
...
_See code: [src/commands/extract.ts](https://github.com/dvhb/react-intl-messages/blob/v0.0.1/src/commands/extract.ts)_
...
_See code: [src/commands/sync.ts](https://github.com/dvhb/react-intl-messages/blob/v0.0.1/src/commands/sync.ts)_
<!-- commandsstop -->
